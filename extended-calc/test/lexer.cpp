		...
		while (true) {
			...
			switch (token.kind()) {
				...
				case calc::token_kind::newline:
					std::cout << "newline";
					break;
				case calc::token_kind::boolean:
					std::cout << "boolean";
					break;
				case calc::token_kind::integer:
					std::cout << "integer";
					break;
				case calc::token_kind::positive_or_addition_operator:
					std::cout << "positive_or_addition_operator";
					break;
				case calc::token_kind::negative_or_subtraction_operator:
					std::cout << "negative_or_subtraction_operator";
					break;
				...
				case calc::token_kind::modulus_operator:
					...
					break;
				case calc::token_kind::equal_operator:
					std::cout << "equal_operator";
					break;
				case calc::token_kind::not_equal_operator:
					std::cout << "not_equal_operator";
					break;
				case calc::token_kind::less_operator:
					std::cout << "less_operator";
					break;
				case calc::token_kind::greater_operator:
					std::cout << "greater_operator";
					break;
				case calc::token_kind::less_equal_operator:
					std::cout << "less_equal_operator";
					break;
				case calc::token_kind::greater_equal_operator:
					std::cout << "greater_equal_operator";
					break;
				case calc::token_kind::logical_not_operator:
					std::cout << "logical_not_operator";
					break;
				case calc::token_kind::logical_and_operator:
					std::cout << "logical_and_operator";
					break;
				case calc::token_kind::logical_or_operator:
					std::cout << "logical_or_operator";
					break;
